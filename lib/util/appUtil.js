...
/**
 * Load zookeeper info from config/zookeeper.json.
 */
var loadZK = function(app) {
  app.loadConfigBaseApp(Constants.RESERVED.ZK, Constants.FILEPATH.ZK);
  app.zookeeper = app.get(Constants.RESERVED.ZK);
};
...
var processArgs = function(app, args) {
  var serverType = args.serverType;
